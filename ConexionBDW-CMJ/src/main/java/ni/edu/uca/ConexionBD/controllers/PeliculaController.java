...
public class PeliculaController {
	...
	@PostMapping("/agregar")
	public String AgregarPelis(@RequestBody Pelicula p) {
	...
	public String EditarPelis(@RequestBody Pelicula p, @PathVariable int id, Model model) {
	...
	public String EliminarPelis(@PathVariable int id, Model model) {
